...
// registry of method
template<>
Utils::RegisteredFactory<Evaluator, ColumnSumEvaluator> ColumnSumEvaluator::reg_("column sum evaluator");
template<>
Utils::RegisteredFactory<Evaluator, ActiveLayerAverageTempEvaluator> ActiveLayerAverageTempEvaluator::reg_("active layer average temperature");
template<>
