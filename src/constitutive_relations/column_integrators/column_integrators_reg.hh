...
// registry of method
template<>
Utils::RegisteredFactory<Evaluator, ColumnSumEvaluator> ColumnSumEvaluator::reg_(
...
template<>
Utils::RegisteredFactory<Evaluator, WaterTableDepthEvaluator> WaterTableDepthEvaluator::reg_(
  "water table depth");
template<>
