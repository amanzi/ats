...
****************************************************************** */
double WRMMacropore::k_relative(double s) {
  return std::pow(s, a_);
}
 ...
 ****************************************************************** */
double WRMMacropore::d_k_relative(double s) {
 ...
 ****************************************************************** */
double WRMMacropore::capillaryPressure(double s) {
  AMANZI_ASSERT(0);
  return 0.;
}
 ...
 ****************************************************************** */
double WRMMacropore::d_capillaryPressure(double s) {
  AMANZI_ASSERT(0);
  return 0.;
}
