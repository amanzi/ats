...
void Preferential::SetupPreferentialFlow_(const Teuchos::Ptr<State>& S)
{
  ...
  if (coupled_to_surface_via_flux_ && coupled_to_surface_via_head_) {
    Errors::Message message("Preferential PK requested both flux and head coupling -- choose one.");
    Exceptions::amanzi_throw(message);
  }
...
// retention, rel perm, etc, that are specific to Preferential.
// -------------------------------------------------------------
...
// Initialize PK
// -------------------------------------------------------------
void Preferential::Initialize(const Teuchos::Ptr<State>& S)
{
...
void Preferential::InitializeHydrostatic_(const Teuchos::Ptr<State>& S)
{
