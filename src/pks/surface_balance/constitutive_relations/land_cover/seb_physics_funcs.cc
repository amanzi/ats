                                  ...
                                  EnergyBalance& eb)
{
  ...
  double u_star = met.Us / std::log(met.Z_Us / snow.roughness);
  double Re0 = u_star * snow.roughness / 1.2e-5;
  double KB = 10 * std::pow(Re0, 0.15) - (-1 * std::log(Re0) + 7);
                               ...
                               const ModelParams& params)
{
  ...
  double Re0 = u_star * surf.roughness / 1.2e-5;
  double KB = 10 * std::pow(Re0, 0.15) - (-1 * std::log(Re0) + 7);
