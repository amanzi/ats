...
.. _evaluator-area-fractions-three-components-spec:
.. admonition:: evaluator-area-fractions-three-components-spec:

   * `"minimum fractional area [-]`" ``[double]`` **1.e-5** Mimimum area
