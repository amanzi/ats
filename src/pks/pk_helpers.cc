...
// -----------------------------------------------------------------------------
void
requireDensityEvaluator(const Key& dens_key, const Tag& tag, State& S, Key other_dens_key)
{
