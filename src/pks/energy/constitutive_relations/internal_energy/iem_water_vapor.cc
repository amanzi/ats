...
double
IEMWaterVapor::InternalEnergy(double temp, double mol_frac_gas)
{
...
double
IEMWaterVapor::DInternalEnergyDT(double temp, double mol_frac_gas)
{
...
double
IEMWaterVapor::DInternalEnergyDomega(double temp, double mol_frac_gas)
{
  // evaluated at constant mol_frac gas for now?
...
void
IEMWaterVapor::InitializeFromPlist_()
{
