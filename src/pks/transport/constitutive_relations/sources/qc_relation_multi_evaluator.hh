...
class QCRelationMultiEvaluator : public EvaluatorSecondaryMonotypeCV {
 public:
  explicit QCRelationMultiEvaluator(Teuchos::ParameterList& plist);
  QCRelationMultiEvaluator(const QCRelationMultiEvaluator& other) = default;

  virtual Teuchos::RCP<Evaluator> Clone() const override
  {
    return Teuchos::rcp(new QCRelationMultiEvaluator(*this));
  }
 ...
 private:
  static Utils::RegisteredFactory<Evaluator, QCRelationMultiEvaluator> reg_;
};
