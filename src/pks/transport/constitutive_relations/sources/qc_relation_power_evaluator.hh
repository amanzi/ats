...
class QCRelationPowerEvaluator : public EvaluatorSecondaryMonotypeCV {
 public:
  explicit QCRelationPowerEvaluator(Teuchos::ParameterList& plist);
  QCRelationPowerEvaluator(const QCRelationPowerEvaluator& other) = default;

  virtual Teuchos::RCP<Evaluator> Clone() const override
  {
    return Teuchos::rcp(new QCRelationPowerEvaluator(*this));
  }
 ...
 private:
  static Utils::RegisteredFactory<Evaluator, QCRelationPowerEvaluator> reg_;
};
