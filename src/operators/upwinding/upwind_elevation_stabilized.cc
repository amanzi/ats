                                        ...
                                        const Teuchos::Ptr<Debugger>& db)
{
  ...
  Teuchos::RCP<const CompositeVector> elev = S->GetPtr<CompositeVector>(elevation_);
  Teuchos::RCP<const CompositeVector> pd = S->GetPtr<CompositeVector>(ponded_depth_);
  Teuchos::RCP<const CompositeVector> manning_coef = S->GetPtr<CompositeVector>(manning_coef_);
  Teuchos::RCP<const CompositeVector> density = S->GetPtr<CompositeVector>(density_);
