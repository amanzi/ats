...
Additionally, the [ATS Input
Spec](https://github.com/amanzi/ats_input_spec) tool can be used to
generate ATS input files through a python script.  Despite this tool,
it is important to be able to parse and understand the resulting xml
file generated by `ats_input_spec.`
